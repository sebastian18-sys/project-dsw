...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="custom-text">
                            <P>Por disposición del Ministerio de Transportes y Comunicaciones todo pasajero debe llenar su formulario Covid-19 para poder embarcar el día de su viaje.</P>
                        </div>
                    </div>
                    <!-- end columns -->
                    <div class="col-sm-12">
                        <div class="flex-content">
                            <div class="custom-form custom-form-fields">
                                <h3>Firmar Declaración Jurada</h3>
                                <!-- <p></p> -->

                                <form class="form-covid" action="validar-pasaje-covid.php" method="POST">
                                    <div>
                                    ...
                                    <input type="submit" value="Siguiente" name="validar" class="btn-orange-next">
                                </form>
                            </div>
                            <!-- end custom-form -->
                        </div>
    ...
    <div class="page-heading">
        <h2>Flujo de viaje</h2>
        <hr class="heading-line" />
    </div>
    <section class="timeline-container">
        <div class="timeline__start-point">
            <div class="timeline__start-point--content"></div>
        </div>
        <div class="timeline__line-center"></div>
        <div class="timeline__content">
            <div class="timeline__content-01">
                <div class="content-01__info-right">
                    <div class="content-01__information">
                        <h3>Antes de viajar</h3>
                        <div class="content-01__information--box">
                            <i class="fa fa-clipboard" aria-hidden="true"></i>
                            <ul>
                                <li class="information__li">DNI / Transporte</li>
                                <li class="information__li">Declaración jurada de salud</li>
                                <li class="information__li">Boleto impreso o digital</li>
                                <li class="information__li">
                                    Uso de mascarilla doble y protector facial
                                </li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="content-01__position">
                    <strong class="content-01__position--text">01</strong>
                </div>
            </div>
            <div class="timeline__content-02">
                <div class="content-01__info-left">
                    <div class="content-01__information">
                        <h3>Llegada al terminal</h3>
                        <div class="content-01__information--box">
                            <i class="fa fa-universal-access" aria-hidden="true"></i>
                            <ul>
                                <li class="information__li">Desinfección de calzado</li>
                                <li class="information__li">
                                    Uso de mascarilla doble y protecctor facial
                                </li>
                                <li class="information__li">Distanciamiento 1.5mts</li>
                                <li class="information__li">Desinfección de manos</li>
                                <li class="information__li">Tomas de temperatura</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="content-01__position">
                    <strong class="content-01__position--text">02</strong>
                </div>
            </div>
            <div class="timeline__content-03">
                <div class="content-01__info-right">
                    <div class="content-01__information">
                        <h3>Control sanitario y de embarque</h3>
                        <div class="content-01__information--box">
                            <i class="fa fa-thermometer-three-quarters" aria-hidden="true"></i>
                            <ul>
                                <li class="information__li">Toma de temperatura</li>
                                <li class="information__li">
                                    Uso de mascarilla doble y protecctor facial
                                </li>
                                <li class="information__li">Declaración jurada y de salud</li>
                                <li class="information__li">Distanciamiento 1.5mts</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="content-01__position">
                    <strong class="content-01__position--text">03</strong>
                </div>
            </div>
            <div class="timeline__content-04">
                <div class="content-01__info-left">
                    <div class="content-01__information">
                        ...
                        <div class="content-01__information--box">
                            ...
                            <ul>
                                <li class="information__li">No se entregará mantas</li>
                                <li class="information__li">
                                    No se entregará comida a bordo
                                </li>
                                <li class="information__li">
                                    Uso de mascarilla doble y protector facial
                                </li>
                                <li class="information__li">
                                    Se prohibe botar desechos en el bus
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="content-01__position">
                    <strong class="content-01__position--text">04</strong>
                </div>
            </div>
        </div>
        <div class="timeline__end-point">
            <div class="timeline__end-point--content"></div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 copy" id="copyright">
                        <p>
                            Copyright © 2021
                            <a href="http://www.bootstrapmb.com/">.Todos los derechos reservados</a>| Wiñaymarca SAC
                        </p>
                    </div>
                </div>
                <!-- end row -->
