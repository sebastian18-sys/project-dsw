...
<body>
            ...
            <div class="collapse navbar-collapse" id="myNavbar1">
                <ul class="nav navbar-nav navbar-right navbar-search-link">
                    ...
                    <li class="dropdown  active">
                        <a href="./contact-php" class="dropdown-toggle">Contacto
                            <span>
                                <!-- <i class="fa fa-angle-down"></i> -->
                            </span>
                        </a>
    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <div class="row mt-5">
                <!-- INFORMACIÓN - ADRESS, PHONE, EMAIL -->
                ...
                <div class="col-lg-12" data-aos="fade-right">
                    ...
                    <div class="container-message">
                                ...
                                <div class="custom-form contact-form">
                                    <form action="correo.php" method="POST" role="form" class="php-email-form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="text" class="form-control" name="matters" placeholder="Asunto" required/>
                        ...
                        <div class="col-lg-6 mt-5 mt-lg-0" data-aos="fade-left">
                            <img src="./images/buses-imgs/foto_no_exif.jpg" alt="contact-image" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5 no-pd-r">
                        <div class="custom-form contact-form">
                            ...
                            <form>
                                <div class="form-group"><input type="text" class="form-control" placeholder="Name" required/><span><i class="fa fa-user"></i></span></div>
                                <div class="form-group"><input type="email" class="form-control" placeholder="Email" required/><span><i class="fa fa-envelope"></i></span></div>
                                <div class="form-group"><input type="text" class="form-control" placeholder="Subject" required/><span><i class="fa fa-info-circle"></i></span></div>
                                <div class="form-group"><textarea class="form-control" rows="4" placeholder="Your Message"></textarea><span><i class="fa fa-pencil"></i></span><button type="submit" class="btn btn-orange btn-block">Enviar</button></div>
                            </form>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-7 no-pd-l">
                        <div class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6509729.487836256!2d-123.77686152799836!3d37.1864783963941!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb9fe5f285e3d%3A0x8b5109a227086f55!2sCalifornia!5e0!3m2!1sen!2s!4v1490695907554"
