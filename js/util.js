...
var Util = {
        ...
        AvanzarCompra: function() {
            ...
            var seleccionado = "images/asientos2/seleccionado.png";
            ...
            console.log(encoded);
            formu.action = "datos-pasajero.php?" + encoded;
            formu.submit();
        },
        avanzar: function() {
            var bolSel = document.forms[1].num_bol_selec.value;
            var bolMax = document.forms[1].bolsMax.value;
            if (bolSel == 0) {
            ...
            if (bolSel > bolMax) {
                if (confirm("Tienes Seleccionados más boletos, deseas volver a seleccionarlos!?")) {
                    ...
                    document.forms[1].num_boletos.focus();
                }
            } else {
                Util.AvanzarCompra();
            }
        ...
        cargar: function() {
            var bMax = document.forms[1].bolsMax;
            var indice = document.forms[1].num_boletos.selectedIndex;
            // var bMax = document.bolsMax;
            // var indice = document.getElementById("num_boletos").selectedIndex;
            bMax.value = indice + 1;
            Util.scrlsts();
        },
        ...
        swapImage: function(imagenSeleccionada) {
            ...
            var img = "images/asientos2/seleccionado.png";
            var path = "../images/asientos2/";
            var bolSel = document.forms[1].num_bol_selec.value;
            // console.log(document.forms[2]);
            var bolMax = document.forms[1].bolsMax.value;
            if (bolSel < bolMax) {
                if (imagen.src.endsWith(img)) {
                    imagen.src = path + id + ".png";
                    document.forms[1].num_bol_selec.value--;
                } else
                    imagen.src = img;
                document.forms[1].num_bol_selec.value++;
            } else
