                        ...
                        <div class="list-block main-block f-list-block">
                            ...
                            <div class="container-dates">
                                <div class="container-dates__form-pago col-lg-12">
                                    <form action="validar-pago-encomienda.php" id="formulario-tarjeta" method="POST">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="group">
                                                    ...
                                                    <input type="text" class="form-control-dates" placeholder="Card holder" name="cardholder-pago" required="required" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="button-container col-sm-12">
                                            <Input class="next-button" name="validar-pago-encomienda" Type="submit" value="Continuar">
                                            <?php if($tipo == "documento") {?>
                                                <a href="./documentos.php"> <input class="back-button" type="button" value="Regresar"> </a>
                                            <?php } else if ($tipo = "paquete") { ?>
                                                <a href="./paquetes.php"> <input class="back-button" type="button" value="Regresar"> </a>
                                            <?php } ?>
                                        </div>
                                    </form>
                                </div>
